...
export const Icons = {
  ...
  shuffleWeighted: (p: IconProps) => <Ic {...p}><circle cx="4.5" cy="12" r="3" fill="currentColor" stroke="none"/><circle cx="19.5" cy="12" r="3" fill="currentColor" stroke="none"/><rect x="7" y="10.5" width="10" height="3" rx="1" fill="currentColor" stroke="none"/></Ic>,
