...
export const Icons = {
  ...
  loopFill: (p: IconProps) => <Ic {...p} fill="currentColor" w={0}><path d="M17 1l4 4-4 4"/><path d="M3 11V9a4 4 0 014-4h14"/><path d="M7 23l-4-4 4-4"/><path d="M21 13v2a4 4 0 01-4 4H3"/></Ic>,
  ...
  loopOneFill: (p: IconProps) => <Ic {...p} fill="currentColor" w={0}><path d="M17 1l4 4-4 4"/><path d="M3 11V9a4 4 0 014-4h14"/><path d="M7 23l-4-4 4-4"/><path d="M21 13v2a4 4 0 01-4 4H3"/><text x="12" y="14.5" fontSize="7" textAnchor="middle" fontWeight="700" fill="currentColor" stroke="none">1</text></Ic>,
  ...
  abFill: (p: IconProps) => <Ic {...p} fill="currentColor" w={0}><path d="M3 18l4-12 4 12M4.5 14h5"/><path d="M14 6h3.5a2.5 2.5 0 010 5H14V6zm0 5h4a2.5 2.5 0 010 5h-4v-5z"/></Ic>,
