...
fn compile_swift() {
    ...
    // fall back to sensible minimums that cover AVAudioPlayer + MediaPlayer APIs.
    ...
    println!("cargo:rerun-if-changed=ios/Sources/MelomaniacPlayer/MelomaniacPlayer.swift");
