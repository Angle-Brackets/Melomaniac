...
pub fn run() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            editor::library_replace_track_audio,
            ...
            storage::playlists_containing_tracks,
            storage::library_remove_tracks_cascade,
            ...
            storage::storage_gc_scan,
            storage::storage_gc_collect,
            storage::storage_gc_largest_blobs,
            storage::storage_gc_find_references,
            storage::storage_force_purge_blob,
            ...
            storage::library_get_listen_stats_range,
